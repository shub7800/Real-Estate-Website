            ...
            <div className='flex flex-col items-center md:items-start mt-10 text-grey-600'>
                <div className='grid grid-cols-2 gap-6 md:gap-10 w-full 2xl:pr28'>
                    <div>
                        ...
                        <p c>Years of Excellance</p>
                    </div>
                    <div>
                        <p className='font-medium text-4xl text-gray-800'>12+</p>
                        <p c>Priject Completed</p>
                    </div>
                    <div>
                        <p className='font-medium text-4xl text-gray-800'>20+</p>
                        <p c>Mn. Sq. Ft. Delivered</p>
                    </div>
                    <div>
                        <p className='font-medium text-4xl text-gray-800'>25+</p>
                        <p c>Onging Project</p>
                    </div>

                </div>
                <p className='my-10 max-w-lg'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Modi provident nihil dignissimos ipsam laudantium. Tempora ratione impedit ipsa quasi aliquam harum quidem, dicta nostrum in recusandae sed, minima maiores. Veritatis?</p>
